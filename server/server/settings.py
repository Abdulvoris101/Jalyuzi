...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Добро пожаловат в Jalyuzi Admin",

    # Copyright on the footer
    "copyright": "Jalyuzi copyright",
    ...
    "icons": {
        ...
        "core.category": "fas fa-bars",
        "core.subcategory": "fas fa-angle-double-right",
        "core.product": "fas fa-dice-d6",
